# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 11:18:18 2019
...
class DataGenerator(object):
    ...
    def stft(self, wavfile, sampling_rate, frame_size, overlapFac=0.75):
        ...
        #Get stft
       # librosa.stft(w, n_fft=len_frame, hop_length=len_hop)
    ...
    def CreateTrainingDataSpectrogram(self, wavfile1, wavfile2, sampling_rate, frame_size, maxFFTSize, vad_threshold):
        ...
        phases=np.angle(speech_mix_spec0)
        ...
        sample_dict = {'phases':phases,'SampleStd': speech_mix_spec_std, 'SampleRaw': speech_mix_spec, 'VAD': speech_VAD, 'IBM': IBM1, 'IRM': IRM1,'Wavfiles': [wavfile1, wavfile2], 'MixtureSignal': speech_mix, 'ZmixedSeries': speech_mix_spec0, 'fmixed': f1, 'tmixed': t1, 'Signal1': speech_1, 'Signal2': speech_2, 'Spectrogram1': speech_1_spec, 'Spectrogram2':speech_2_spec }
...
#Set file
#file = "../../TIMIT/Train/DR1/FCJF0/SI1027.wav"
#file = "Audios/Train/DR1/XU/huizhen.wav"
file = "Audio/Train/DR1/FCJF0/SI1027_.wav"
...
#%% Delete variables 
del file, wavfile1, wavfile2,  spectrogram1, sampling_rate, frame_size, data_generator
...
#data_dir = "../../speech-separation/TIMIT/Train/DR1"
data_dir = "Audio/Train/DR1"
...
wavfile1 = "Audio/Train/DR1/FCJF0/SI1027_.wav"
wavfile2 = "Audio/Train/DR1/MDPK0/SI552_.wav"
#wavfile1 = "Audios/Train/DR1/XU/huizhen.wav"
#wavfile2 = "Audios/Train/DR2/CAI/quanwu.wav"
#wavfile1 = "Audio/Train/DR1/FCJF0/SI1027_.wav"
#wavfile1 = "Audio/Train/DR1/FCJF0/SI1027_.wav"
#wavfile2 = "Audio/Train/DR3/FMJF0/SI1254_.wav"
#wavfile2 = "Audio/Train/DR3/FJLR0/SI1231_.wav"
...
plt.savefig("recovered signal.png")
...
#data_dir = "../../TIMIT/Train/DR8"
#data_dir = "Audios/Train/DR2"
data_dir = "Audio/Train/DR2"
...
#parentfolder = "../../TIMIT/Train"
parentfolder = "Audio/Train"
...
#Set folder containing folders of wav files from TIMIT data set 
#parentfolder = "../../speech-separation/TIMIT/TEST"
parentfolder = "Audio/Test"
